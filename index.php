  ...
  <nav class="navbar navbar-inverse" style="height:80px">
    <div class="container-fluid">
      ...
      <div id="sesison" style="float:right ; margin-top:20px ; margin-right:20px">
        <p style="float:left ; font-size:15px ; margin-top : 10px; color:white;display:none;" id="userName">Logged in as :&nbsp&nbsp<span style="font-size:15px; color:white;" id="username"><?php session_start();
                                                                                                                                                                                              if (isset($_SESSION)) {
      ...
      <div class="col-md-6" style="margin-top:50px">
        ...
        <div class="form-group">
          ...
          <div class="panel panel-success">
            ...
            <div class="panel-body">
              <div id="display_space" style="border:3px solid white;width:1020px;height:150px;overflow:hidden">
            ...
            <div class="panel-footer">
              <div class="form-group">
                <textarea class="form-control" placeholder="press any key to begin" rows="1" wrap="off" id="typing_space" style="font-size:25px ; padding: 10px; text-align:center;"></textarea>
              </div>
            </div>
